function     [p_walking, bout_starts, bout_ends, bout_durations]=percentage_walking_func(walking,min_bout_duration_sec, limit)
    % --- 7. Bout validi (>60s) ---
