...
folderPath = 'long-term-movement-monitoring-database-1.0.0'; % Percorso della cartella
filePattern = 'FL*.hea'; % Pattern per trovare i file header (assumiamo uno per soggetto/registrazione)
...
save('daysFLData',"allSubjectData")